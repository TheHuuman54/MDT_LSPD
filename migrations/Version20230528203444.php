 ...
 */
final class Version20230528203444 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE arrestation_sentences (arrestation_id INT NOT NULL, sentences_id INT NOT NULL, INDEX IDX_11F11D4031042105 (arrestation_id), INDEX IDX_11F11D40175906F5 (sentences_id), PRIMARY KEY(arrestation_id, sentences_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
